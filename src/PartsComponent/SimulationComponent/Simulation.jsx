...
const Simulation = ({ onFinishSimulation }) => {
 ...
 const [showIntroScreen, setShowIntroScreen] = useState(() => {
  ...
  return started !== 'true' || location.state?.fromQuestions || location.state?.fromEndPage;
});
...
if (showIntroScreen) {
  return (
    <div className="simulation-fullscreen intro-screen">
      ...
      {/* הוספת NavigationButtons למסך הפתיחה */}
      <NavigationButtons showNext={false} allowNext={true} showIntroScreen={true} />
    </div>
  );
}
